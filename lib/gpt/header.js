...
function Header( buffer ) {
  ...
  // TODO: read UInt64
  this.currentLBA = buffer.slice( 24, 32 )
  
  // Backup LBA (location of the other header copy)
  // TODO: read UInt64
  this.backupLBA = buffer.slice( 32, 40 )
  ...
  // this.partitionTableLBA = buffer.slice( 72, 80 )
  this.partitionTableLBA = buffer.readUInt32LE( 72 )
